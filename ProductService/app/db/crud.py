...
async def add_product(db: AsyncSession, product: schemas.ProductCreate) -> schemas.Product:
...
async def update_product(db: AsyncSession, product_id: int, product: schemas.ProductUpdate) -> schemas.Product:
